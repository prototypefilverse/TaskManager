    ...
    <div class="main-container">
        ...
        <div class="task-input-container">
            ...
            <div class="logout-container">
              <form action="${pageContext.request.contextPath}/logoutServlet" method="get" style="margin: 0; padding: 0;"> <!-- マージンとパディングをリセット -->
                ...
                <tbody>
                    <%
                        ...
                        try {
                            ...
                            String sql = "SELECT id, title, description, due_date, status FROM tasks WHERE user_id = ? ORDER BY created_at DESC";
